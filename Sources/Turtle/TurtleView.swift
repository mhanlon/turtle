...
//                path.lineWidth = CGFloat(turtle.penSize)
...
//                var avatar = self.viewWithTag(turtle.tag!)
//                if avatar != nil {
